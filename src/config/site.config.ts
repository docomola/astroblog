...
const siteConfig: SiteConfig = {
  name: 'DOCOMOLA',
  description: 'Code & thoughts — personal blog & projects',
  url: SITE_URL || 'https://docomola.github.io/astroblog',
  ogImage: '/og-default.svg',
  author: 'docomola',
  email: 'docomola@users.noreply.github.com',
  address: {
    street: '',
    city: '',
    state: '',
